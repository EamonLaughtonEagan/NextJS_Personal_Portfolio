...
import { Code2, Database, Layers, Wrench, ArrowRight, Award, TrendingUp, Shield } from "lucide-react";

export default function TechnicalSkills() {
    const totalSkills = technicalSkills.reduce((acc, cat) => acc + cat.skills.length, 0);

    return (
        <div className="p-5">
            <AnimatedHeader fullText="Technical" speed={50} />
            <p className="text-xl text-foreground/60 mb-12">
                An overview of my technical skills and expertise across primarily frontend and backend development.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                ...
                <Card className="group cursor-default">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-3xl font-bold text-foreground">{technicalSkills.length}</h3>
